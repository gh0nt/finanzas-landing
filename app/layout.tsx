...
export const metadata: Metadata = {
  ...
  description:
    "Compara productos financieros, consulta la TRM y tasas de interés en tiempo real, y aprende finanzas personales con la plataforma educativa de referencia en España.",
  keywords: [
    "comparador financiero España",
    "finanzas personales",
    "TRM hoy España",
    "tasas de interés España",
    "CDTs España",
    "cuentas de ahorro España",
